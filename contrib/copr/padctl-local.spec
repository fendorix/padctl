...
#        git archive --format=tar.gz --prefix=padctl-0.1.23/ HEAD \
#          -o ~/rpmbuild/SOURCES/padctl-0.1.23.tar.gz
#
...
#        sudo dnf install ~/rpmbuild/RPMS/$(uname -m)/padctl-0.1.23-1.fc44.$(uname -m).rpm
...
%changelog
* Thu Jul 09 2026 padctl maintainers <maintainers@padctl.dev> - 0.1.23-1
- Update version to 0.1.23

* Thu Jul 09 2026 padctl maintainers <maintainers@padctl.dev> - 0.1.22-1
