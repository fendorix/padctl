...
#        git archive --format=tar.gz --prefix=padctl-0.1.22/ HEAD \
#          -o ~/rpmbuild/SOURCES/padctl-0.1.22.tar.gz
#
...
#        sudo dnf install ~/rpmbuild/RPMS/$(uname -m)/padctl-0.1.22-1.fc44.$(uname -m).rpm
